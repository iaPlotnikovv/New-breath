...
type DefaultAPIServicer interface { 
	...
	BannerIdPatch(context.Context, int32, BannerIdPatchRequest, string) (ImplResponse, error)
	BannerPost(context.Context, BannerPostRequest, string) (ImplResponse, error)
